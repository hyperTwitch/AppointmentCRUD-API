...
Data can be sent to the API as either a query string (http://localhost:3000/read?id=1) or as a JSON payload.
...
Running this will require you to have the following installed: * node.js * sqlite3 which can be installed using the following npm install sqlite3